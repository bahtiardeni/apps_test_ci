...
class Pegawai extends MyController
{
    ...
    public function __construct()
    {
        ...
        $this->datatable->set_initial("data-pegawai");
        $this->rebuild_fields();
    ...
    public function update($hash = "")
    {
        ...
        else
        {
            ...
            if (empty($hash_id)){
                $this->template->data["title"]          = "TAMBAH PEGAWAI";
            }else{
                $this->template->data["title"]          = "UBAH PEGAWAI";
            }
    ...
    public function detail($hash = "")
    {
        ...
        if (!empty($data))
        {
            ...
            $this->template->data["title"]          = "DETAIL PEGAWAI";
