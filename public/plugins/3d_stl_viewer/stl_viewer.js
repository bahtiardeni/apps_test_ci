//=========== Stl Viewer v1.10, by Omri Rips, Viewstl.com, June 2020 ; admin@viewstl.com ===========
...
function StlViewer(e, t) {
	...
	this.error = null, this.options = t, this.parent_element = e, this.get_opt = function (e, t) {
		...
		o.canvas_width = o.get_opt("width", o.canvas_width), o.canvas_height = o.get_opt("height", o.canvas_height), o.bg_color = o.get_opt("bgcolor", o.bg_color), o.models_to_add = o.get_opt("models", o.models_to_add), o.model_loaded_callback = o.get_opt("model_loaded_callback", o.model_loaded_callback), o.all_loaded_callback = o.get_opt("all_loaded_callback", o.all_loaded_callback), o.load_error_callback = o.get_opt("load_error_callback", o.load_error_callback), o.loading_progress_callback = o.get_opt("loading_progress_callback", o.loading_progress_callback), o.onmousedown_callback = o.get_opt("on_model_mousedown", o.onmousedown_callback), o.onmousedown_callback || (o.onmousedown_callback = o.get_opt("on_model_mouseclick", null)), o.send_no_model_click_event = o.get_opt("send_no_model_click_event", o.send_no_model_click_event), o.zoom = o.get_opt("zoom", o.zoom), o.camerax = o.get_opt("camerax", o.camerax), o.cameray = o.get_opt("cameray", o.cameray), o.auto_rotate = o.get_opt("auto_rotate", o.auto_rotate), o.mouse_zoom = o.get_opt("mouse_zoom", o.mouse_zoom), o.ready_callback = o.get_opt("ready_callback", null), o.auto_resize = o.get_opt("auto_resize", o.auto_resize), o.on_model_drop = o.get_opt("on_model_drop", o.on_model_drop), o.center_models = o.get_opt("center_models", o.center_models), o.controls_type = o.get_opt("controls", o.controls_type), o.zoom >= 0 ? o.cameraz = o.zoom : o.cameraz = o.get_opt("cameraz", o.cameraz), o.camera_state = o.get_opt("camera_state", o.camera_state), o.allow_drag_and_drop && o.set_drag_and_drop(!0)
	}, o.is_ie = !!window.MSStream, this.MSG2WORKER_DATA = 0, this.MSG2WORKER_LOAD = 1, this.MSG2WORKER_ERROR = 2, this.MSGFROMWORKER_STL_LOADED = 3, this.MSGFROMWORKER_LOAD_IN_PROGRESS = 4, this.load_model = function (e) {
		return o.max_model_id = Math.max(o.max_model_id, e.id), e.filename || e.local_file ? o.load_from_stl_file(e, !1) : e.mesh ? o.add_from_existing_mesh(e) : void o.models_count--
	}, this.add_from_existing_mesh = function (e) {
		o.set_model_custom_props(e), e.mesh.model_id = e.id, o.set_geo_minmax(e), o.recalc_dims(e), e.color = e.mesh.material.color.getHexString(), o.scene.add(e.mesh), o.model_loaded(e.id), o.check_loading_status(e, 0, 0), e.mesh.geometry.boundingBox || e.mesh.geometry.computeBoundingBox(), o.model_loaded_callback && o.model_loaded_callback(e.id)
		...
		t.onmessage = function (a) {
			switch (a.data.msg_type) {
				case o.MSGFROMWORKER_STL_LOADED:
					...
					t.terminate(), t = void 0, o.pre_loaded_ab_files && e.filename && o.pre_loaded_ab_files[e.filename] && delete o.pre_loaded_ab_files[e.filename];
					break;
				case o.MSGFROMWORKER_LOAD_IN_PROGRESS:
					o.check_loading_status(e, a.data.loaded, a.data.total);
					break;
				case o.MSG2WORKER_ERROR:
					o.models_count--, o.model_error("ERROR: " + a.data.data, o.load_error_callback), o.pre_loaded_ab_files && e.filename && o.pre_loaded_ab_files[e.filename] && delete o.pre_loaded_ab_files[e.filename]
			}
		}, e.bytes_loaded = 0, e.bytes_total = 0;
		var a = null;
		o.pre_loaded_ab_files && e.filename && o.pre_loaded_ab_files[e.filename] && (a = o.pre_loaded_ab_files[e.filename]), t.postMessage({
		...
		o.loaded_models_arr[e] = 1, Object.keys(o.loaded_models_arr).length >= o.models_count && (o.camera_state ? o.camera_state = null : o.set_zoom(), o.set_light(), o.load_session++, o.all_loaded_callback && o.all_loaded_callback())
		...
		t && (delete o.models[o.models_ref[e]], delete o.models_ref[e], delete o.loaded_models_arr[e], o.max_model_id = -1, Object.keys(o.models_ref).forEach(function (e) {
			o.max_model_id = Math.max(o.models[o.models_ref[e]].id, o.max_model_id)
		}), o.models_count = Object.keys(o.models).length, o.scene.remove(t.mesh))
		...
		var e = new THREE.Vector3, t = new THREE.Vector3, a = new THREE.Vector3(0, 0, 0);
		return e.copy(o.camera.position), t.copy(o.camera.up), o.controls && a.copy(o.controls.target), {
			position: e,
			up: t,
			target: a
		}
		...
		if (void 0 !== e.position) {
			if (void 0 === e.position.x) return o.model_error("set_camera_state - invalid position x");
			if (void 0 === e.position.y) return o.model_error("set_camera_state - invalid position y");
			if (void 0 === e.position.z) return o.model_error("set_camera_state - invalid position z");
			o.camera.position.set(e.position.x, e.position.y, e.position.z)
		}
		if (void 0 !== e.up) {
			if (void 0 === e.up.x) return o.model_error("set_camera_state invalid up x");
			if (void 0 === e.up.y) return o.model_error("set_camera_state invalid up y");
			if (void 0 === e.up.z) return o.model_error("set_camera_state invalid up z");
			o.camera.up.set(e.up.x, e.up.y, e.up.z)
		}
		if (o.controls && void 0 !== e.target) {
			if (void 0 === e.target.x) return o.model_error("set_camera_state - invalid target x");
			if (void 0 === e.target.y) return o.model_error("set_camera_state - invalid target y");
			if (void 0 === e.target.z) return o.model_error("set_camera_state - invalid target z");
		...
		t && (o.zoom = t), o.camera.position.set(o.is_empty(e) ? o.camera.position.x : e, o.is_empty(t) ? o.camera.position.y : t, o.zoom >= 0 ? o.zoom : Math.max(3 * o.maxx, 3 * o.maxy, 3.5 * o.maxz))
		...
		e.x = e.x ? e.x : 0, e.y = e.y ? e.y : 0, e.z = e.z ? e.z : 0, e.mesh.position.set(e.x, e.y, e.z), e.color ? o.update_mesh_color(e.mesh, e.color, !1) : e.colors && o.update_mesh_color(e.mesh, "#FFFFFF", !0), e.rotationx = e.rotationx ? e.rotationx : 0, e.rotationy = e.rotationy ? e.rotationy : 0, e.rotationz = e.rotationz ? e.rotationz : 0, (e.rotationx || e.rotationy || e.rotationz) && o.set_rotation(e.id, e.rotationx, e.rotationy, e.rotationz);
		var t = void 0 !== e.scale ? e.scale : 1, a = void 0 !== e.scalex ? e.scalex : t,
			i = void 0 !== e.scaley ? e.scaley : t, s = void 0 !== e.scalez ? e.scalez : t;
		e.scalex = a, e.scaley = i, e.scalez = s, 1 == a && 1 == i && 1 == s || o.scale_geo(e, a, i, s), e.view_edges && o.set_or_update_geo_edges(e, !0), e.opacity && this.set_material_opacity(e.mesh.material, e.opacity), e.animation && (o.animation[e.id] = 1)
		...
		if (s && s.mesh && s.mesh.geometry) {
			var n = Math.max(s.scalex, .01), l = Math.max(s.scaley, .01), r = Math.max(s.scalez, .01);
			t && (s.scalex = Math.max(t, .01)), s.scaley = Math.max(a || t, .01), s.scalez = Math.max(i || t, .01), o.scale_geo(s, s.scalex / n, s.scaley / l, s.scalez / r), s.edges && o.set_or_update_geo_edges(s, !0, !0)
		}
		...
		null != e && ("transparent" != t ? (e.traverse(function (e) {
			e.visible = !0
		}), e.material.vertexColors = o ? THREE.FaceColors : THREE.NoColors, o && !t && (t = "#FFFFFF"), t && e.material.color.set(parseInt(t.substr(1), 16)), e.material.needsUpdate = !0) : e.traverse(function (e) {
			e.visible = !1
		}))
	}, this.set_color = function (e, t) {
		if (void 0 === o.models_ref[e]) return o.model_error("set_color - id not found: " + e);
		var a = o.models[o.models_ref[e]];
		a && a.mesh && (a.color = t, o.update_mesh_color(a.mesh, t, !t && a.colors))
	}, this.error_in_model = function (e) {
		if (!e.id && 0 != e.id && -1 != e.id) return o.model_error("missing id");
		...
		return o.models_ref[e.id] ? o.model_error("such model ID already exists: " + e.id) : null
		...
		switch (e.stopPropagation(), e.preventDefault(), e.type) {
			case"touchstart":
				...
				o.mouse.x = (t.pageX - o.parent_element.offsetLeft) / o.parent_element.clientWidth * 2 - 1, o.mouse.y = -(t.pageY - o.parent_element.offsetTop) / o.parent_element.clientHeight * 2 + 1;
				break;
			default:
				o.mouse.x = (e.clientX - o.parent_element.offsetLeft) / o.parent_element.clientWidth * 2 - 1, o.mouse.y = -(e.clientY - o.parent_element.offsetTop) / o.parent_element.clientHeight * 2 + 1
		}
		o.raycaster.setFromCamera(o.mouse, o.camera);
		var a = o.raycaster.intersectObjects(o.scene.children);
		if (a.length > 0) {
			if (void 0 === a[0].object.model_id) return;
			o.onmousedown_callback && o.onmousedown_callback(a[0].object.model_id, e, a[0].distance)
		} else o.send_no_model_click_event && o.onmousedown_callback(null, e, 0)
		...
		var s = o.models[o.models_ref[e]];
		s && s.mesh && (s.x = o.is_empty(t) ? s.x : t, s.y = o.is_empty(a) ? s.y : a, s.z = o.is_empty(i) ? s.z : i, s.mesh.position.set(s.x, s.y, s.z), s.edges && o.set_or_update_geo_edges(s, !0, !0))
	...
	}, this.set_rotation = function (e, t, a, i, s) {
		if (void 0 === o.models_ref[e]) return o.model_error("rotate - id not found: " + e);
		var n = o.models[o.models_ref[e]];
		if (n) {
			var l = s ? 1 : 0;
			t && (n.rotationx = t + n.mesh.rotation.x * l, n.mesh.rotation.x = n.rotationx), a && (n.rotationy = a + n.mesh.rotation.y * l, n.mesh.rotation.y = n.rotationy), i && (n.rotationz = a + n.mesh.rotation.y * l, n.mesh.rotation.z = n.rotationz), n.mesh.updateMatrixWorld(), n.edges && o.set_or_update_geo_edges(n, !0)
		}
	}, this.rotate = function (e, t, a, i) {
		o.set_rotation(e, t, a, i, !0)
	}, this.get_model_filename = function (e, t) {
		return e.orig_filename ? e.orig_filename : e.temp_filename ? e.temp_filename : e.orig_url ? e.orig_url : e.local_file && e.local_file.name ? e.local_file.name : e.filename ? e.filename instanceof File ? File.name : e.filename : t ? "model_" + e.id + ".stl" : null
		...
		var s = o.models.indexOf(e);
		return t || void 0 === o.models_ref[e.id] && o.models_count++, o.models_ref[e.id] = s, o.load_model(e), o.status
		...
		return {
			...
			rotation: {x: t.mesh.rotation.x, y: t.mesh.rotation.y, z: t.mesh.rotation.z},
		...
		var e = [];
		return Object.keys(o.models_ref).forEach(function (t) {
		...
		return Object.keys(o.models_ref).forEach(function (e) {
			var s = o.models[o.models_ref[e]], n = {id: s.id};
			if (a) {
				var l = o.get_model_filename(s, !0);
				l && (n.filename = t ? o.basename(l) : l)
			} else s.filename && (n.filename = t ? o.basename(s.filename) : s.filename), s.local_file && (n.local_file = s.local_file);
			s.x && (n.x = s.x), s.y && (n.y = s.y), s.z && (n.z = s.z), s.display && (n.display = s.display), s.color && (n.color = s.color), s.rotationx && (n.rotationx = s.rotationx), s.rotationy && (n.rotationy = s.rotationy), s.rotationz && (n.rotationz = s.rotationz), void 0 === s.scale || a || 1 != s.scale && (n.scale = s.scale), 1 == s.scalex || a || (n.scalex = s.scalex), 1 == s.scaley || a || (n.scaley = s.scaley), 1 == s.scalez || a || (n.scalez = s.scalez), void 0 !== s.opacity && 1 != s.opacity && (n.opacity = s.opacity), s.view_edges && (n.view_edges = s.view_edges), s.animation && (n.animation = JSON.parse(JSON.stringify(s.animation)), delete n.animation.start_time, delete n.animation.last_time), i.models[o.models_ref[e]] = n
		}), e ? i : o.json_without_nulls(i)
	}, this.download_vsj = function (e) {
		var t = new Blob([o.get_vsj()], {type: "application/json"}), a = document.createElement("a");
		a.href = window.URL.createObjectURL(t);
		var i = e || "1", s = i.toLowerCase().indexOf(".vsj");
		s >= 0 && (i = i.substring(0, s)), i.length < 1 && (i = "1"), a.download = i + ".vsj", a.click()
	}, this.load_vsj = function (e) {
		if (!e) return o.pre_loaded_vsj ? (stl_viewer.init_by_json(o.pre_loaded_vsj), o.pre_loaded_vsj = null, !0) : o.model_error("load_vsj - invalid filename" + e, o.load_error_callback);
		if (e instanceof File) return o.read_bin_file(e, o.init_by_json, null, !0);
		var t = new XMLHttpRequest;
		t.onreadystatechange = function (e) {
			4 == t.readyState && 200 == t.status && o.init_by_json(t.response.trim())
		}, t.open("GET", e, !0), t.send(null)
	}, this.padend = function (e, t, o) {
		return t >>= 0, o = String(void 0 !== o ? o : " "), e.length > t ? String(e) : ((t -= e.length) > o.length && (o += o.repeat(t / o.length)), String(e) + o.slice(0, t))
	}, this.get_normal = function (e, t, o) {
		var a = t.x - e.x, i = t.y - e.y, s = t.z - e.z, n = o.x - e.x, l = o.y - e.y, r = o.z - e.z,
			d = {x: 0, y: 0, z: 0};
		d.x = i * r - s * l, d.y = s * n - a * r, d.z = a * l - i * n;
		var _ = Math.sqrt(d.x * d.x + d.y * d.y + d.z * d.z);
		return 0 != _ && (d.x /= _, d.y /= _, d.z /= _), d
	}, this.get_stl_bin = function (e) {
		if (void 0 === o.models_ref[e]) return o.model_error("get_stl_bin - id not found: " + e);
		var t = o.models[o.models_ref[e]];
		if (t && t.mesh) {
			var a = t.mesh.geometry;
			if (a) {
				for (var i = new ArrayBuffer(84 + 50 * a.faces.length), s = new DataView(i), n = (new TextEncoder, o.padend("Binary" + (t.colors ? " colored" : "") + " STL by viewstl.com", 80, " ")), l = 0; l < 80; l++) s.setUint8(l, n.charCodeAt(l), !0);
				s.setUint32(80, a.faces.length, !0);
				var r = 84;
				return Object.keys(a.faces).forEach(function (e) {
					var i = a.faces[e], n = a.vertices[i.a], l = a.vertices[i.b], d = a.vertices[i.c],
						_ = o.get_normal(n, l, d);
					s.setFloat32(r, _.x, !0), r += 4, s.setFloat32(r, _.y, !0), r += 4, s.setFloat32(r, _.z, !0), r += 4, s.setFloat32(r, n.x, !0), r += 4, s.setFloat32(r, n.y, !0), r += 4, s.setFloat32(r, n.z, !0), r += 4, s.setFloat32(r, l.x, !0), r += 4, s.setFloat32(r, l.y, !0), r += 4, s.setFloat32(r, l.z, !0), r += 4, s.setFloat32(r, d.x, !0), r += 4, s.setFloat32(r, d.y, !0), r += 4, s.setFloat32(r, d.z, !0), r += 4, t.colors ? s.setUint16(r, Math.ceil(31 * i.color.r) | Math.ceil(31 * i.color.g) << 5 | Math.ceil(31 * i.color.b) << 10, !0) : s.setUint16(r, 0, !0), r += 2
				}), i
			}
		}
		...
		return JSON.stringify(e).split(",null").join("")
	}, this.download_vsb = function (e) {
		var t = null;
		try {
			t = new JSZip
		} catch (e) {
			return console.log("download_vsb - JSZip is missing ", e.message), !1
		}
		var a = o.get_vsb();
		t.file("json_data.vsj", o.json_without_nulls(a.vsj)), Object.keys(a.files).forEach(function (e) {
			var i = o.get_model_filename(a.vsj.models[o.models_ref[a.files[e].id]], !0);
			t.file(o.basename(i), a.files[e].bin)
		}), t.generateAsync({type: "blob"}).then(function (t) {
			var o = new Blob([t], {type: "application/zip"}), a = document.createElement("a");
			a.href = window.URL.createObjectURL(o);
			var i = e || "1", s = i.toLowerCase().indexOf(".vsb");
			s >= 0 && (i = i.substring(0, s)), i.length < 1 && (i = "1"), a.download = i + ".vsb", a.click()
		})
	}, this.load_vsb = function (e) {
		if (o.pre_loaded_ab_files = [], o.pre_loaded_vsj = null, e instanceof File) return o.read_bin_file(e, o.load_vsb_from_blob);
		JSZipUtils.getBinaryContent(decodeURIComponent(e), function (e, t) {
			if (e) return o.model_error("load_vsb " + e, o.load_error_callback);
		...
		t.loadAsync(e).then(function () {
			o.zip_load_count = Object.keys(t.files).length, t.forEach(function (e, a) {
				"json_data.vsj" == a.name ? t.files[a.name].async("string").then(function (e) {
					o.pre_loaded_vsj = e, o.zip_load_count--, 0 == o.zip_load_count && o.load_vsj(null)
				}) : t.files[a.name].async("blob").then(function (e) {
					o.pre_loaded_ab_files[a.name] = e, o.zip_load_count--, 0 == o.zip_load_count && o.load_vsj(null)
				})
			})
		})
	},this.load_bin_to_ab_file = function (e, t) {
		o.pre_loaded_ab_files || (o.pre_loaded_ab_files = []), o.pre_loaded_ab_files[e] = t, o.add_model({
			id: -1,
			filename: e
		})
	},this.download_model = function (e, t) {
		if (void 0 === o.models_ref[e]) return o.model_error("download_model - id not found: " + e);
		var a = o.models[o.models_ref[e]];
		if (a && a.mesh) {
			var i = new Blob([o.get_stl_bin(e)], {type: "application/sla"}), s = document.createElement("a");
			s.href = window.URL.createObjectURL(i);
			var n = t || (a.filename ? a.filename : a.local_file ? a.local_file.name : "1"),
				l = n.toLowerCase().indexOf(".stl");
			l >= 0 && (n = n.substring(0, l)), n.length < 1 && (n = "1"), s.download = n + ".stl", s.click()
		}
		...
		var e = o.parent_element.getBoundingClientRect(), t = e.width, a = e.height;
		...
		}), requestAnimationFrame(o.animate), o.renderer.render(o.scene, o.camera), o.controls && o.controls.update()
			...
			switch (l) {
				...
				case"rotationz":
					if (!s) {
						...
						void 0 === t.rotxtotal && (t.rotxtotal = t.rotationx - r.x), void 0 === t.rotytotal && (t.rotytotal = t.rotationy - r.y), void 0 === t.rotztotal && (t.rotztotal = t.rotationz - r.z), o.rotate(e.id, void 0 !== t.rotationx ? t.rotxtotal * a : 0, void 0 !== t.rotationy ? t.rotytotal * a : 0, void 0 !== t.rotationz ? t.rotztotal * a : 0)
					}
					break;
				case"scale":
				case"scalex":
	...
	},this.init_done = !1,this.init = function () {
		if (!o.init_done) {
			switch (o.WORLD_X_VECTOR = new THREE.Vector3(1, 0, 0), o.WORLD_Y_VECTOR = new THREE.Vector3(0, 1, 0), o.WORLD_Z_VECTOR = new THREE.Vector3(0, 0, 1), o.edges_material = new THREE.LineBasicMaterial({color: 0}), o.raycaster = new THREE.Raycaster, o.mouse = new THREE.Vector2, o.scene = new THREE.Scene, o.is_webgl = webgl_Detector.webgl, o.renderer = o.is_webgl ? new THREE.WebGLRenderer({
				preserveDrawingBuffer: !0,
				alpha: !0
			}) : new THREE.CanvasRenderer({alpha: !0}), o.camera = new THREE.PerspectiveCamera(45, 1, .1, 1e4), o.parent_element.appendChild(o.renderer.domElement), o.scene.add(o.camera), o.ambientLight = new THREE.AmbientLight(2105376), o.camera.add(o.ambientLight), o.directionalLight = new THREE.DirectionalLight(16777215, .75), o.directionalLight.position.x = 1, o.directionalLight.position.y = 1, o.directionalLight.position.z = 2, o.directionalLight.position.normalize(), o.camera.add(o.directionalLight), o.pointLight = new THREE.PointLight(16777215, .3), o.pointLight.position.x = 0, o.pointLight.position.y = -25, o.pointLight.position.z = 10, o.camera.add(o.pointLight), o.controls_type) {
				case 1:
					o.controls = new THREE.TrackballControls(o.camera, o.renderer.domElement);
					break;
				default:
					o.controls = new THREE.OrbitControls(o.camera, o.renderer.domElement), o.controls.autoRotate = o.auto_rotate
			}
			o.set_on_model_mousedown(o.onmousedown_callback)
		}
		o.set_bg_color(o.bg_color), !1 === o.mouse_zoom && o.set_mouse_zoom(o.mouse_zoom), o.camera_state ? o.set_camera_state(o.camera_state) : o.camera.position.set(o.camerax, o.cameray, o.cameraz), o.do_resize(), o.models_to_add && o.add_models(o.models_to_add), o.set_auto_resize(o.auto_resize), o.animate(), o.init_done = !0
	},this.set_auto_resize = function (e) {
		o.do_resize && (window.removeEventListener("resize", o.do_resize), e && window.addEventListener("resize", o.do_resize))
	},this.vf_to_geo = function (e, t, a) {
		if (!e) return null;
		if (!t) return null;
		var s = [], n = [], l = e.length;
		for (i = 0; i < l; i++) s.push(new THREE.Vector3(e[i][0], e[i][1], e[i][2]));
		l = t.length;
		if (a) for (i = 0; i < l; i++) {
			var r = new THREE.Face3(t[i][0], t[i][1], t[i][2]);
			r.color.setRGB(t[i][3], t[i][4], t[i][5]), n.push(r)
		} else for (i = 0; i < l; i++) n.push(new THREE.Face3(t[i][0], t[i][1], t[i][2]));
		...
		var t = e.mesh.geometry;
		if (t.boundingBox) t.minx = t.boundingBox.min.x, t.miny = t.boundingBox.min.y, t.minz = t.boundingBox.min.z, t.maxx = t.boundingBox.max.x, t.maxy = t.boundingBox.max.y, t.maxz = t.boundingBox.max.z; else {
			for (var o = t.vertices, a = o[0].x, i = o[0].y, s = o[0].z, n = o[0].x, l = o[0].y, r = o[0].z, d = o.length; d--;) o[d].x < a && (a = o[d].x), o[d].y < i && (i = o[d].y), o[d].z < s && (s = o[d].z), o[d].x > n && (n = o[d].x), o[d].y > l && (l = o[d].y), o[d].z > r && (r = o[d].z);
			t.minx = a + e.x, t.miny = i + e.y, t.minz = s + e.z, t.maxx = n + e.x, t.maxy = l + e.y, t.maxz = r + e.z
		}
	},this.handleDragOver = function (e) {
		e.stopPropagation(), e.preventDefault(), e.dataTransfer.dropEffect = "copy"
	},this.handleFileDrop = function (e) {
		e.stopPropagation(), e.preventDefault(), e.dataTransfer.files.length > 0 ? o.load_local_files(e.dataTransfer.files) : "string" == typeof e.dataTransfer.getData("Text") && (o.add_model({
			id: -1,
		...
		if (e.length > 0) {
			for (var t = new Array, a = e.length, i = 0; i < a; i++) {
		...
		o.parent_element = e, o.allow_drag_and_drop && o.set_drag_and_drop(!0), o.set_on_model_mousedown(o.onmousedown_callback), o.parent_element.appendChild(o.renderer.domElement)
	},this.scripts_loader = null,this.external_files_loaded = function () {
		o.ready = !0, o.init(), o.ready_callback && o.ready_callback()
	},this.load_three = function (e) {
		"string" != typeof o.load_three_files && (o.load_three_files = ""), o.scripts_loader = new ScriptsLoader, o.scripts_loader.load_scripts(new Array(e + "three.min.js", e + "webgl_detector.js", e + "Projector.js", e + "CanvasRenderer.js", e + (0 == o.controls_type ? "OrbitControls.js" : "TrackballControls.js")), o.external_files_loaded)
	...
	},o.set_options(),o.ready ? (o.init(), o.ready_callback && o.ready_callback()) : !1 !== o.load_three_files ? o.load_three(o.load_three_files) : o.model_error("No THREE files were loaded")
}
...
function ScriptsLoader() {
	...
	this.all_loaded_callback = null, this.scripts_to_load = new Array, this.loading_scripts = new Array, this.loaded_scripts = new Array, this.scripts_are_loaded = function (t) {
		var o = Object.keys(t);
		for (i = o.length; i--;) if (!e.loaded_scripts[e.get_full_name(t[i])]) return !1;
		return !0
		...
		o && (e.all_loaded_callback = o), Object.keys(t).forEach(function (o) {
			...
			-1 == e.scripts_to_load.indexOf(a) && (e.loading_scripts[a] || e.loaded_scripts[a] || e.scripts_to_load.push(t[o]))
		}), e.load_files()
	}, this.load_files = function () {
		if (0 != e.scripts_to_load.length) for (; e.scripts_to_load.length;) {
...
Number.isInteger = Number.isInteger || function (e) {
	...
	if (!window.MSStream) {
		var e = document.currentScript.attributes.src.value, t = e.lastIndexOf("/");
