...
;(function ($, window, document, undefined) {
	...
	ComboTree.prototype.createSourceItemHTML = function (sourceItem) {
		...
		if (isThereSubs)
			itemHtml += '<span class="comboTreeParentPlus">' + (this.options.collapse ? '<span class="fa fa-caret-down"></span>' : '<span class="fa fa-caret-up"></span>') + '</span>'; // itemHtml += '<span class="comboTreeParentPlus">' + (this.options.collapse ? '+' : '&minus;') + '</span>';
	...
	ComboTree.prototype.toggleSelectionTree = function (item, direction) {
		...
		if (direction === undefined) {
			if ($(subMenu).is(':visible'))
				$(item).children('span.comboTreeParentPlus').html('<span class="fa fa-caret-down"></span>'); //$(item).children('span.comboTreeParentPlus').html("+");
			else
				$(item).children('span.comboTreeParentPlus').html('<span class="fa fa-caret-up"></span>'); //$(item).children('span.comboTreeParentPlus').html("&minus;");
